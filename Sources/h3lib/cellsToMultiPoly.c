...
static H3Error createGlobeMultiPolygon(GeoMultiPolygon *mpoly) {
    ...
    const LatLng verts[8][3] = {
        {{__M_PI_2_2, 0.0}, {0.0, 0.0}, {0.0, __M_PI_2_2}},
        {{__M_PI_2_2, 0.0}, {0.0, __M_PI_2_2}, {0.0, _M_PI_2}},
        {{__M_PI_2_2, 0.0}, {0.0, _M_PI_2}, {0.0, -__M_PI_2_2}},
        {{__M_PI_2_2, 0.0}, {0.0, -__M_PI_2_2}, {0.0, 0.0}},
        {{-__M_PI_2_2, 0.0}, {0.0, 0.0}, {0.0, -__M_PI_2_2}},
        {{-__M_PI_2_2, 0.0}, {0.0, -__M_PI_2_2}, {0.0, -_M_PI_2}},
        {{-__M_PI_2_2, 0.0}, {0.0, -_M_PI_2}, {0.0, __M_PI_2_2}},
        {{-__M_PI_2_2, 0.0}, {0.0, __M_PI_2_2}, {0.0, 0.0}},
