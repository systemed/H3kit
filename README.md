...
Furthermore, H3 defines more than one grid size for the planet. In fact H3 defines 16 distinct 'resolutions' ranging from 0.0000009 km^2 up to 4,250,546.8477000 km^2. There is a parent/child relationship between two cells at adjacent resolutions. 
